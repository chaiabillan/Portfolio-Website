import website from '../../assets/images/instockwebsite.png';
                ...
                <div>
                    <ul className='project__details'>
                        <li className='project__details--item'>
                            <strong>Collaborative Agile Practices: </strong> Played a pivotal role in the collaborative development of 'InStock,' an inventory management system project, by embracing Agile methodologies, Git Flow, and Scrum practices, fostering effective communication and teamwork within the project group to ensure the timely delivery of a scalable solution.
                        </li>
                        <li className='project__details--item'>
                            <strong>Teamwork Excellence: </strong> Demonstrated strong collaborative skills, actively participating in task planning sessions, utilizing Jira Scrum boards for task management, engaging in daily stand-ups, and upholding rigorous standards in Git Flow, code review, and pull request processes, contributing to the project's successful completion on schedule.
                        </li>
                    </ul>
                </div>
            </div>
