...
import website from '../../assets/images/alllergycompass website.png';
                ...
                <div>
                    <ul className='project__details'>
                        <li className='project__details--item'>
                            <strong>Full-Stack Mastery: </strong> Showcased advanced proficiency in full-stack development through the realization of "My Allergy Compass", my capstone project. Leveraged React, Express, and MySQL to construct diverse features including a community forum, emergency phone lookup, and a comprehensive travel guide, all while meticulously adhering to industry-standard practices in code structuring and seamless API integration.
                        </li>
                        <li className='project__details--item'>
                            <strong>Project Management Evolution: </strong> Orchestrated the development by adeptly implementing Agile methodologies for task organization, sprint planning, and efficient time management, culminating in the creation of a robust travel application tailored for individuals with food allergies.
                        </li>
                    </ul>
                </div>
            </div>
